 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 5     // Degrees Celsius //MM was 4

  //#define ADAPTIVE_FAN_SLOWING              // Slow part cooling fan if temperature drops //MM
...
// @section bltouch
   ...
   */
   //#define BLTOUCH_SET_5V_MODE //MM disabled to save space
   ...
   */
   #define BLTOUCH_HS_MODE true //MM disable to save space

  // Safety: Enable voltage mode settings in the LCD menu.
  //  #define BLTOUCH_LCD_VOLTAGE_MENU //MM disabled to save space
...
//
 //#define ASSISTED_TRAMMING //MM Disable if too much
#if ENABLED(ASSISTED_TRAMMING)

  // Define positions for probe points.
  #define TRAMMING_POINT_XY { {  31, 26 }, { 193, 30 }, { 193, 207 }, { 26, 201 } } //MM
 ...
 //#define ASSISTED_TRAMMING_WIZARD    // Add a Tramming Wizard to the LCD menu //MM Disable if too much
 ...
 */
#define INPUT_SHAPING_X //MM
#define INPUT_SHAPING_Y //MM
#if EITHER(INPUT_SHAPING_X, INPUT_SHAPING_Y)
  #if ENABLED(INPUT_SHAPING_X)
    #define SHAPING_FREQ_X  43.59          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.10f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  49.41          // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y  0.18f       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #define SHAPING_MIN_FREQ  10         // By default the minimum of the shaping frequencies. Override to affect SRAM usage. //MM was 20
  #define SHAPING_MAX_STEPRATE 20000   // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage. //MM was 10000
  #define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters. //MM
#endif
 ...
 */
#define DEFAULT_STEPPER_DEACTIVE_TIME 300 //MM
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
   ...
   //#define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu //MM Disable if too much.
...
#define SET_PROGRESS_MANUALLY           //MM Disable to save space
...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    //MM // Double-click on the Status Screen for Z Babystepping.
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 //MM
...
#define LIN_ADVANCE //MM
    ...
    #define ADVANCE_K { 0.51 }    // (mm) Compression length per 1mm/s extruder speed, per extruder //MM was 0.22
  #else
    #define ADVANCE_K 0.51        // (mm) Compression length applying to all extruders //MM was 0.22
  #endif
  //#define ADVANCE_K_EXTRA       // Add a second linear advance constant, configurable with M900 L.
  //#define LA_DEBUG              // Print debug information to serial during operation. Disable for production use.
  #define EXPERIMENTAL_SCURVE   // Allow S-Curve Acceleration to be used with LA. //MM
...
// G2/G3 Arc Support
//
 //#define ARC_SUPPORT                   // Requires ~3226 bytes //MM
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 32  //MM was 8
#elif ENABLED(SDSUPPORT)
  #define BLOCK_BUFFER_SIZE 32  //MM was 16
#else
  #define BLOCK_BUFFER_SIZE 16  //MM was 16
#endif
 ...
 */
#define ADVANCED_PAUSE_FEATURE //MM goes with M600
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         60  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            6  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     100  // (mm/s) Unload filament feedrate. This can be pretty fast. //MM
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      780  // (mm) The length of filament for a complete unload. //MM
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  100  // (mm/s) Load filament feedrate. This can be pretty fast. //MM
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   830  // (mm) Load length of filament, from extruder gear to nozzle. //MM
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           90  // (seconds) Time limit before the nozzle is turned off for safety. //MM was 45
  #define FILAMENT_CHANGE_ALERT_BEEPS         1  // Number of alert beeps to play when a response is needed. /MM was 10
 ...
 */
//#define NO_WORKSPACE_OFFSETS //MM
 ...
 */
#define HOST_ACTION_COMMANDS //MM Disable if too much space
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76               //MM // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT          //MM // Initiate host prompts to get user feedback
  #if ENABLED(HOST_PROMPT_SUPPORT)
    //#define HOST_STATUS_NOTIFICATIONS  //MM // Send some status messages to the host as notifications
  #endif
  //#define HOST_START_MENU_ITEM         //MM // Add a menu item that tells the host to start
